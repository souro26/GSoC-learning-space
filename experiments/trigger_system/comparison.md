...
The difference is not in correctness, but in execution efficiency.

Polling assumes:

evaluate at every step

Trigger-based evaluation assumes:
...
This becomes important in models where:

- state changes are sparse
- agents evaluate multiple behavioral rules
